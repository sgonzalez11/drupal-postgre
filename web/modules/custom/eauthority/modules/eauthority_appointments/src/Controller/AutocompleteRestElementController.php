 ...
 */
class AutocompleteRestElementController extends ControllerBase {
  ...
  public function autocomplete(Request $request, WebformInterface $webform, $key) {
    ...
    if (isset($q)) {
      ...
      $options = \_eauthority_appointments_get_values($element['#rest_endpoint'], $q);

      // Adapt each response to JSON
