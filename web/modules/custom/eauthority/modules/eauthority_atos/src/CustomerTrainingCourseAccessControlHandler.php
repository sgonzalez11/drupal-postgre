 ...
 *
 * @see \Drupal\eauthority_atos\Entity\CustomerTrainingCourse.
 */
class CustomerTrainingCourseAccessControlHandler extends EntityAccessControlHandler {

  /**
   * {@inheritdoc}
   */
  protected function checkAccess(EntityInterface $entity, $operation, AccountInterface $account) {
    /** @var \Drupal\eauthority_atos\Entity\CustomerTrainingCourseInterface $entity */
    switch ($operation) {
      case 'view':
