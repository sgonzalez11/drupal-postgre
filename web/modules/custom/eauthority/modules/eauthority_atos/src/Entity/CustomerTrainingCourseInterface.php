 ...
 */
interface CustomerTrainingCourseInterface extends ContentEntityInterface, EntityChangedInterface, EntityOwnerInterface {
   ...
   *
   * @return \Drupal\eauthority_atos\Entity\CustomerTrainingCourseInterface
