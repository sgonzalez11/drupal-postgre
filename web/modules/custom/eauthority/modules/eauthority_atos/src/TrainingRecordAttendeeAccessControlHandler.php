 ...
 *
 * @see \Drupal\eauthority_atos\Entity\TrainingRecordAttendee.
 */
class TrainingRecordAttendeeAccessControlHandler extends EntityAccessControlHandler {

  /**
   * {@inheritdoc}
   */
  protected function checkAccess(EntityInterface $entity, $operation, AccountInterface $account) {
    /** @var \Drupal\eauthority_atos\Entity\TrainingRecordAttendeeInterface $entity */
    switch ($operation) {
      case 'view':
