 ...
 */
class MedicalAssessmentCancelForm extends ContentEntityForm {
    ...
    public function buildForm(array $form, FormStateInterface $form_state) {
        ...
        if (!$entity->canBeCanceled()) {
            drupal_set_message(t("It is not possible to cancel the selected Medical Assessment. The same one is not cancelleable."), "error");
        ...
        $form['#theme'] = 'medical_assessment__cancel';
    ...
    public function validateForm(array &$form, FormStateInterface $form_state) {
        ...
        if ($current_entity_status == 'CAN') {
            drupal_set_message(t("The Medical Assessment has already a status set to Cancel."), 'error');
            $form_state->setError($form, t("The Medical Assessment has already a status set to Cancel."));
        }
    }
