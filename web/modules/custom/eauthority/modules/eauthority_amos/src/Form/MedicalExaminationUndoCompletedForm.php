 ...
 */
class MedicalExaminationUndoCompletedForm extends ContentEntityForm {
    ...
    public function buildForm(array $form, FormStateInterface $form_state) {
        ...
        $form['#theme'] = 'medical_examination__undo_completed';
        $form['#entityId'] = $formId;

        // Special changes for this undo completed form
    ...
    public function validateForm(array &$form, FormStateInterface $form_state) {
        ...
        if ($current_entity_status == 'SCH') {
            drupal_set_message(t("The Medical Examination has already a status set to Scheduled."), 'error');
            $form_state->setError($form, t("The Medical Examination has already a status set to scheduled."));
        }
    }
    ...
    public function submitForm(array &$form, FormStateInterface $form_state) {
        ...
        //Call the method to change the entity status to undo completed
        if ($entity->undoCompleted()) {
    ...
    protected function actions(array $form, FormStateInterface $form_state) {
        ...
        if ($this->entity->hasLinkTemplate('undo-completed-form')) {
