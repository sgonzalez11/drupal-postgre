...
class ProfileExtension extends MaestroTaskConsoleController {
  ...
  public function getTransactions() {
    return [
      '#markup' => $this->t('Transactions would be here')
    ];
  }

  public function getAppointments() {
    return [
      '#markup' => $this->t('Appointments would be here')
    ];
  }

  public function getNotifications() {
    return [
      '#markup' => $this->t('Notifications would be here')
    ];
  }
